...
// ADMIN_TOKEN, NEXT_PUBLIC_SUPABASE_URL, SUPABASE_SERVICE_KEY
// SENDGRID_API_KEY, FROM_EMAIL
// Optional: DEFAULT_TO_EMAIL, BRAND_NAME
...
export async function POST(request) {
  ...
  const resp = await fetch('https://api.sendgrid.com/v3/mail/send', {
    ...
    body: JSON.stringify({
      ...
      from: { email: process.env.FROM_EMAIL, name: brand },
  ...
  if (!resp.ok) {
    ...
    return new Response(JSON.stringify({ error: `SendGrid: ${text}` }), { status: 500 })
  }
